...
public class NativeIO {
    ...
    static {
        if (NativeCodeLoader.isNativeCodeLoaded()) {
            try {
                ...
                PerformanceAdvisory.LOG.debug("Unable to initialize org.apache.hadoop.io.nativeio.NativeIO libraries", var1);
            }
        }
    ...
    public static class POSIX {
        ...
        private static void assertCodeLoaded() throws IOException {
            if (!isAvailable()) {
                throw new IOException("org.apache.hadoop.io.nativeio.NativeIO was not loaded");
            }
        }
        ...
        public static void chmod(String path, int mode) throws IOException {
            if (!Shell.WINDOWS) {
                ...
                try {
                    ...
                    LOG.warn(String.format("org.apache.hadoop.io.nativeio.NativeIO.chmod error (%d): %s", var3.getErrorCode(), var3.getMessage()));
        ...
        public static NativeIO.POSIX.Stat getFstat(FileDescriptor fd) throws IOException {
            ...
            if (!Shell.WINDOWS) {
                ...
                try {
                    ...
                    LOG.warn(String.format("org.apache.hadoop.io.nativeio.NativeIO.getFstat error (%d): %s", var3.getErrorCode(), var3.getMessage()));
                    throw new NativeIOException("Unknown error", Errno.UNKNOWN);
                }
            }
        ...
        public static NativeIO.POSIX.Stat getStat(String path) throws IOException {
            if (path == null) {
                ...
                try {
                    ...
                    LOG.warn("org.apache.hadoop.io.nativeio.NativeIO.getStat error ({}): {} -- file path: {}", new Object[]{var3.getErrorCode(), var3.getMessage(), path});
